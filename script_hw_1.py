...
a = input('enter plate letters and numbers: ')
a = a.upper()
if a in plates_list:
    print('plate exists')
else:
    print('plate does not exist')
b = list(a)   # make list from string
# print(b)
del b[0:2]  # delete fist letters in the plate
del b[4:6]  # delete last letters in the plate
# print(b)
nums_list = [int(s) for s in b]   # made numbers out of string
# print(nums_list)
total = sum(nums_list)
print(f'total sum of numbers in the plate is: {total}')
